...
const FloatingCard: React.FC<FloatingCardProps> = ({ 
  ...
  return (
    <div 
      className="group bg-[#ECE8E3]/5 border border-[#ECE8E3]/10 rounded-2xl p-8 hover:border-[#D4AF37]/30 transition-all duration-300 hover:shadow-xl hover:shadow-[#D4AF37]/20 hover:-translate-y-4 hover:scale-105 floating-card hover-glow-enhanced interactive-glow h-full flex flex-col"
